 ...
 * @endcode
 */
$settings['hash_salt'] = 'yN9BiBDqxzmJR4MTZ0iZfnNC28bEjVY2j1z5xllxGZaoPlv7mOai82oqGV9YzAEFapi9KKwVmw';
...
$config['config_split.config_split.tl_site']['status'] = TRUE;
$config['config_split.config_split.win_site']['status'] = FALSE;
